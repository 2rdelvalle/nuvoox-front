...
const AppConfig = (props: AppConfigProps) => {
  ...
  useEffect(() => {
    changeTheme?.(layoutConfig.theme, "indigo", "theme-link", () => {
      setLayoutConfig((prevState) => ({ ...prevState, theme: "indigo" }))
    })
            ...
            >
                ...
                <div className="field-radiobutton">
                    <RadioButton
                        ...
                        inputId="mode-dim"
                    ></RadioButton>
                    <label htmlFor="mode-dim">Combinado</label>
                </div>
                <div className="field-radiobutton">
                    <RadioButton
                        name="colorScheme"
